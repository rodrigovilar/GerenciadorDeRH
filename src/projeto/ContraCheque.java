...
public class ContraCheque {
	...
	public ContraCheque(Funcionario funcionario) throws FuncionarioNullExeption{//construtor
		if(funcionario != null){			
			...
			informacoes = this.emitirContraCheque();
		}else{
	...
	private String toStringContraCheque() {//gera a representação textual do contracheque
	...
	public void gerarDescontos(){//Gera o total de descontos para o funcionário
